    ...
    <div className="min-h-[calc(100vh-5rem)] flex flex-col justify-center">
      <div className="text-center space-y-6 max-w-3xl mx-auto px-4">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-shoprite-dark">
          Welcome to Shoprite Receipt Portal
        </h1>
        
        <p className="text-xl text-gray-600">
          View your shopping receipts, track your purchases, and monitor store sales all in one place.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <h3 className="text-lg font-semibold mb-2">Digital Receipts</h3>
            <p className="text-gray-600">Access all your shopping receipts digitally, no more paper clutter.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Track your purchases over time and review your shopping patterns.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">View comprehensive sales data and performance metrics for your store.</p>
          </div>
        </div>
      </div>
    </div>
